...
export default function WalletCard_Processing() {
  ...
  const dataFetch = async () => {
    ...
    const data = await (
      await fetch("/api/walletCard/walletCard_Processing_find", {
        method: "POST",
  ...
  return (
    <VStack width={"100%"} h="100%" borderWidth={0} p="10px" overflowY={"auto"} >
      {fetchData &&
